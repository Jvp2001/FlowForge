        ...
        if (!inputXNodes.isEmpty())
        {
            for (Node inputXNode : inputXNodes)
            {
                switch (inputXNode)
                {
                    ...
                    case GreaterThanOrEqualNode greaterThanOrEqualNode ->
                            print(textField.getText() + greaterThanOrEqualNode.getIsGreaterOrEqual());
                    case LessThanOrEqualNode lessThanOrEqualNode ->
                            print(textField.getText() + lessThanOrEqualNode.getIsLessOrEqual());
